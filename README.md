...
For this project, the first version was solved which has only one agent.
...
1. Download dependencies from [DRLND Github Repository](https://github.com/udacity/deep-reinforcement-learning#dependencies)
